...
public final class HttpClientUtil {
	...
	public static String sendPostRequest(String url,List<BasicNameValuePair> params)
			throws Exception {
		CloseableHttpClient httpclient = HttpClients.createDefault();
		HttpPost httpPost = new HttpPost(new URL(url).toURI());

		UrlEncodedFormEntity dataEntity = new UrlEncodedFormEntity(params,DEFAULT_ENCODING);
		httpPost.setEntity(dataEntity);
		CloseableHttpResponse response = null;
		BufferedReader reader = null;
		if (null != httpclient) {
