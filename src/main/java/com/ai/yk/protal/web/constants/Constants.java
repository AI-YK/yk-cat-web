...
public final class Constants {
	...
	/** 默认缓存命名空间 */
	public static final String DEFAULT_YC_CACHE_NAMESPACE = "com.ai.yk.protal.web.default.cache";
	/** 公共缓存命名空间*/
	public static final String DEFAULT_COMMON_CACHE_NAMESPACE = "com.ai.yk.common.default.cache";
	...
	/** 缓存命名空间 */
	public static final String CACHE_NAMESPACE = "com.ai.yk.user.email.cache";
	/** ip可重复发送次数保存时间 配置key */
