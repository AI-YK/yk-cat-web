 ...
 *
 */
public class QueryMyInformationDetailsVo implements Serializable {
    ...
    private Date createTimeView;
    private Date updateTimeView;
	...
	public void setIsSpend(String isSpend) {
	...
	public Date getCreateTimeView() {
		return createTimeView;
	}
	public void setCreateTimeView(Date createTimeView) {
		this.createTimeView = createTimeView;
	}
	public Date getUpdateTimeView() {
		return updateTimeView;
	}
	public void setUpdateTimeView(Date updateTimeView) {
		this.updateTimeView = updateTimeView;
	}
	public Date getcCreateTimeView() {
		return cCreateTimeView;
	}
	public void setcCreateTimeView(Date cCreateTimeView) {
		this.cCreateTimeView = cCreateTimeView;
	}
}
