	...
	<!--面包屑导航-->
		...
		<div class="cooperation-banner">
				...
				<div class="cooperation-list" id="scrollDiv">
					<ul>
						<li class="img-icon"><img src="../images/Jinshan-icon1.png" /></li>
						<li class="word">
				...
				<div class="cooperation-icon"><a href="#" id="but_up"><img src="../images/cooper-icon.png" /></a></div>
			</div>
		</div>
...
<script type="text/javascript" src="../scripts/modular/jq_scroll.js"></script>
