	...
	<div class="hot-news-main">
		<div class="hot-news-main-left">
			<div class="sentiment-title blue">
				<ul>
					<li>新闻热点</li>
					<li class="right"><a  href="${_base}/search/public?model=news"><i class="icon iconfont">&#xe65b;</i></a></li>
				</ul>
			</div>
		...
		<div class="hot-news-main-left ml-20">
			<div class="sentiment-title blue">
				<ul>
					<li>社交热点</li>
					<li class="right"><a  href="${_base}/search/public?model=social"><i class="icon iconfont">&#xe65b;</i></a></li>
				</ul>
			</div>
			<div class="news-tabtitle">
